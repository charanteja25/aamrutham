...
const PILLARS = [
  ...
  },
  {
    ...
    members: [
      {
        name: 'Sitaramaswamy Kankanalapalli',
  ...
  },
  {
    ...
    members: [
      ...
      },
      {
        ...
        tag: 'Harvest',
        image: '/assets/team/pyditalli.jpg',
      },
    ],
  },
  {
      ...
      {hasImage ? (
        <img
          ...
          style={{
            ...
            height: '100%',
            objectFit: 'cover',
            objectPosition: member.facePos || 'center 20%',
            display: 'block',
          }}
        />
      ) : (
        ...
        >
          ...
          >
            {member.fallback || member.name.charAt(0)}
          </div>
      ...
      >
        <defs>
          ...
          <filter id="softShadow" x="-30%" y="-30%" width="160%" height="160%">
            <feDropShadow dx="0" dy="6" stdDeviation="8" floodColor="#5B3A15" floodOpacity="0.16" />
          </filter>
